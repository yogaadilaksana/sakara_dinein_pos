      ...
      <div className="flex-1 p-6">
        {shiftId ? (
          ...
          <>
            ...
            <button className="mb-6 px-4 py-2 border rounded border-slate-500 text-slate-500 hover:bg-slate-400 hover:text-white">Print Shift Report</button>
            {selectedShiftDetails && (
              <div className="bg-white p-4 rounded shadow mb-6">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="border-b pb-2">{format(selectedShiftDetails.startingShift, "eeee, do 'of' MMMM yyyy 'at' hh:mm a", { locale: enUS })}</div>
