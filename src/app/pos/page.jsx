...
const Page = () => {
  ...
  // useEffect(()=>{
  //   fetch(`/api/product/terjual?startTime=${encodeURIComponent(dated)}&endTime=${encodeURIComponent(dated)}`)
  //     .then(response => response.json())
  //     .then(data => setProductTerjual(data));
  // }, [dated]);

  // useEffect(()=>{
  //   fetch(`/api/product/refund?startTime=${encodeURIComponent(dated)}&endTime=${encodeURIComponent(dated)}`)
  //     .then(response => response.json())
